  ...
  return (
    <div className='bg-black md:w-4/5 mx-auto relative overflow-hidden'>
      <div className='w-full py-16 px-12'> 
        <h2 className=' text-3xl  text-white font-bold'>强化你的公司</h2>
        <p className='text-lg text-white mt-2 mb-6'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique, voluptas asperiores officia deleniti, aspernatur blanditiis quos qui exercitationem distinctio quis cumque illo sint omnis labore, natus mollitia eaque odit dolores.
        </p>
